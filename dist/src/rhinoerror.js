...
export const HttpErrorNameToCode = new Map(Object.entries(HttpErrorCodes));
export const HttpErrorCodeToName = new Map(Object.entries(HttpErrorCodes).map(([k, v]) => [v, `HttpError${k}`]));
/**
    ...
    constructor(code, message, error, debugInfo, userInfo) {
        ...
        if (typeof code === 'number') {
            if (HttpErrorCodeToName.has(code)) {
                this.name = HttpErrorCodeToName.get(code);
            }
        }
...
//# sourceMappingURL=rhinoerror.js.map